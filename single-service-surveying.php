<?php
/**
 * Single Service — صفحة داخلية مخصصة لخدمة هندسة المساحة (slug: surveying)
 * ديزين الصفحة الداخلية القديم + كل داتا المساحة (الأقسام الخمسة + الخدمات الفرعية)
 */
get_header(); ?>
...
?>
    ...
    <section class="relative h-[60vh] min-h-[500px] flex items-center justify-center overflow-hidden bg-slate-800">
        ...
        <div class="relative z-10 container px-4 sm:px-6 text-center text-white">
            ...
            <h1 class="text-4xl md:text-6xl lg:text-7xl font-bold mb-3 leading-tight animate-fade-in-up delay-100">هندسة المساحة والجيوماتكس</h1>
            <div class="w-24 h-1.5 bg-blue-600 mx-auto rounded-full mb-6 animate-fade-in-up delay-200"></div>
            <p class="text-base md:text-lg text-blue-100 max-w-2xl mx-auto mb-8 animate-fade-in-up delay-200">حلول مساحية شاملة.. من الرصد الأرضي إلى الفضاء</p>
    ...
    <?php get_template_part('template-parts/service', 'survey'); ?>
