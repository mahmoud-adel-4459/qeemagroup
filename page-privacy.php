 ...
 * صفحة سياسة الخصوصية فقط — لا تحتوي على الشروط والأحكام
 * المحتوى الكامل في: template-parts/content-privacy.php
 */
if (!defined('ABSPATH')) exit;
get_header();

$privacy_updated = '1 يناير 2025';
$privacy_email  = get_bloginfo('admin_email');
$privacy_phone  = '';
$privacy_address = '';
?>

<!-- Hero: سياسة الخصوصية فقط -->
<section class="pt-32 pb-12 md:pb-16 relative overflow-hidden min-h-[240px] flex items-center">
    <div class="absolute inset-0">
        <img src="<?php echo esc_url(visionary_get_hero_image_url('privacy')); ?>" alt="" class="w-full h-full object-cover">
    ...
    <div class="container relative z-10 px-4 sm:px-6">
        <div class="max-w-3xl text-right">
            <h1 class="text-3xl md:text-4xl lg:text-5xl font-bold text-white mb-4">سياسة الخصوصية — قيمة جروب</h1>
            <p class="text-lg text-blue-100">نلتزم بحماية بياناتك وخصوصيتك وفق أعلى المعايير.</p>
        </div>
    </div>
</section>
