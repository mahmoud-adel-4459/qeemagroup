<?php
/**
 * Single Service — صفحة داخلية مخصصة للتصميم المعماري والإنشائي (slug: architectural-design)
 * ديزين الصفحة الداخلية القديم + كل داتا الخدمة
 */
get_header(); ?>
...
?>
    ...
    <?php get_template_part('template-parts/service', 'architectural'); ?>
